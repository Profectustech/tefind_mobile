...
class _SellerAccountgState extends ConsumerState<SellerAccount> {
  ...
  final GlobalKey<FormState> _sellerKey = GlobalKey<FormState>();
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                        controller: accountProvider.sellerBankName,
                        hint: "Bank Name",
                      ...
                      CustomTextFormField(
                        ...
                        controller: accountProvider.sellerBankAccountNumber,
                      ...
                      CustomTextFormField(
                          controller: accountProvider.sellerBankAccountName,
                          validator: Validators().isEmpty,
                          ),
                      SizedBox(
                        height: 30.h,
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: CustomButton(
                  onPressed:  () async {
                 //   accountProvider.createSellerAccount();
                    if (_sellerKey.currentState!.validate()) {
                      bool isSuccess =
                      await accountProvider.createSellerAccount();
                      if (isSuccess) {
