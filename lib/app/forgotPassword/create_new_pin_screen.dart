...
class CreateNewPinScreen extends ConsumerStatefulWidget {
  const CreateNewPinScreen({super.key});

  @override
  ConsumerState<CreateNewPinScreen> createState() => _CreateNewPinScreenState();
}

class _CreateNewPinScreenState extends ConsumerState<CreateNewPinScreen> {
